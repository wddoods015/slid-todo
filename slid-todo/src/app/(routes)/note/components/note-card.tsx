...
const NoteCard = ({ note }: NoteCardProps) => {
  return (
    <div className="grid gap-2.5 grid-cols-1 bg-white w-1/2 p-[24px] border-[1px] border-slate-100 rounded-xl cursor-pointer transform transition-transform duration-200 hover:scale-105 hover:bg-slate-50">
